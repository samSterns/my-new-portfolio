...
const darkMode = getPrefColorScheme();
    ...
    return (
      <div className={darkMode ? "dark-mode" : "light-mode"}>
        ...
        <div id="container-case-study-audit">
            ...
            <div className="wrapper">
              ...
              <ul>
              <h3 className="h3-process">Research</h3>
              ...
              <h3 className="h3-process">Analysis</h3>
            ...
            <div className="wrapper-color-contrast">
                ...
                <img style={{width: '200px'}} src={after1} alt="screenshot of application after" />
