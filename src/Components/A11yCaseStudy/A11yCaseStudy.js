    ...
    <div className={darkMode ? "dark-mode" : "light-mode"}>
        ...
        <div id="container-case-study">
            ...
            <div className="wrapper">
                <h2>The Problem</h2>
                <p>Online reviews do not provide a good user experience for someone who has low-vision or uses a screen reader. How can we improve the experience for people with disabilities when reading or listening to reviews? How can we create a trusted community and gather informative reviews? How can we improve searching through reviews to find accessability related topics?
                </p>
            </div>
            <h2>My Contributions</h2>
                <h3>User Research</h3>
                    <ul>Research Methodologies: 10 Interviews and 25 Surveys and still counting</ul>
                        ...
                        <li>I conducted follow up research based on my findings. Including market research to learn more about the apps and assistive devices people had mentioned. As well as document the ways the current app stores let users post reviews</li>
                ...
                <h3>UX and UI Design</h3>
                    <p>Final designs coming soon...</p>

                
            <h2>What I Learned</h2>
            <div className="wrapper">
                <h3>More about Human Centered Design</h3>
                <p>While creating a product for people with disabilities it is imperative to understand how people other than you navigate a website. I learned a lot more about screen readers and other assistive devices. </p>
            </div>
            <div className="wrapper">
                <h3>Collaborating with a team of designers on a long-term project</h3>
                <p>It was a pleasure to take the time and truly research potential users. With this project I combined all my existing familiarity with digital accessability and I got to interview people for about a month, which set me up to design for others and not myself.</p>
            </div>
        </div>
    </div>
    )
